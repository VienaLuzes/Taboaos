...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Lay_04_atlas_.png?1489667498811", id:"Lay_04_atlas_"}
	]
};
...
lib.ssMetadata = [
		{name:"Lay_04_atlas_", frames: [[0,769,956,481],[1024,691,1024,685],[1024,0,1024,689],[0,1252,962,476],[964,1378,960,474],[964,769,54,58],[0,0,1022,767],[1926,1695,100,43],[1926,1378,100,163],[1926,1543,85,150],[2013,1594,27,46],[2013,1543,29,49],[2028,1412,18,31],[2028,1378,18,32]]}
];
...
(lib.Lay_04 = function(mode,startPosition,loop) {
	...
	// Lay_04.psd
	this.instance_38 = new lib.Urso2dcopiar3();
	this.instance_38.setTransform(50,626);

	this.instance_39 = new lib.Urso2dcopiar3_1();
	this.instance_39.setTransform(50,626);

	this.instance_40 = new lib.Urso2dcopiar2();
	this.instance_40.setTransform(201,581);

	this.instance_41 = new lib.Urso2dcopiar2_1();
	this.instance_41.setTransform(200,580);
