...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Lay_04_atlas_.png?1489667903550", id:"Lay_04_atlas_"}
	]
};
...
lib.ssMetadata = [
		{name:"Lay_04_atlas_", frames: [[1024,691,1024,685],[1024,0,1024,689],[0,769,960,475],[0,1246,955,463],[0,0,1022,767],[34,1711,18,25],[957,1378,982,395],[0,1775,974,390],[1941,1378,100,43],[976,1775,274,219],[1252,1775,259,205],[962,769,42,65],[0,1711,32,51],[1513,1775,127,93],[1642,1775,113,78]]}
];
...
(lib.VERMELHOcopycopiar = function() {
	this.spriteSheet = ss["Lay_04_atlas_"];
	this.gotoAndStop(13);
}).prototype = p = new cjs.Sprite();
...
(lib.VERMELHOcopycopiar2 = function() {
	this.spriteSheet = ss["Lay_04_atlas_"];
	this.gotoAndStop(14);
}).prototype = p = new cjs.Sprite();
...
(lib.Lay_04 = function(mode,startPosition,loop) {
	...
	// Lay_04.psd
	this.instance_38 = new lib.Camada4copiar();
	this.instance_38.setTransform(69,128);

	this.instance_39 = new lib.Camada4();
	this.instance_39.setTransform(64,121);

	this.instance_40 = new lib.Polígono1copiar9();
	this.instance_40.setTransform(48,606);

	this.instance_41 = new lib.Polígono1copiar8();
	this.instance_41.setTransform(41,599);

	this.instance_42 = new lib.VERMELHOcopycopiar2();
	this.instance_42.setTransform(164,559);

	this.instance_43 = new lib.VERMELHOcopycopiar();
	this.instance_43.setTransform(157,552);

	this.instance_44 = new lib.Polígono1copiar7();
	this.instance_44.setTransform(696,311);

	this.instance_45 = new lib.Polígono1copiar6();
	this.instance_45.setTransform(688,304);

	this.instance_46 = new lib.Estrelacopiar16();
	this.instance_46.setTransform(50,254);

	this.instance_47 = new lib.Estrelacopiar12();
	this.instance_47.setTransform(192,592);

	this.instance_48 = new lib.Estrelacopiar15();
	this.instance_48.setTransform(42,250);

	this.instance_49 = new lib.Camada1();
	this.instance_49.setTransform(0,83);

	this.instance_50 = new lib.Camada5();
	this.instance_50.setTransform(1,0);

	this.instance_51 = new lib.Camada2();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_51},{t:this.instance_50},{t:this.instance_49},{t:this.instance_48},{t:this.instance_47},{t:this.instance_46},{t:this.instance_45},{t:this.instance_44},{t:this.instance_43},{t:this.instance_42},{t:this.instance_41},{t:this.instance_40},{t:this.instance_39},{t:this.instance_38}]}).wait(1));
